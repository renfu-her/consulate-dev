	 ...
	 <?php }?> 
        ...
        <tr>
          ...
          <td width="63%" class="form_list_2"><label>
            <input name="pro_name" type="text" id="ProName" size="50" dataType="Require" msg="產品名稱未輸入"/>
          </label></td>
        ...
        <tr>
          ...
          <td class="form_list_2"><input name="price" type="text" id="price" size="5" value="0" dataType="Integer" msg="價錢請輸入整數"/></td>
          <td class="form_list_3">&nbsp;</td>
        </tr>
        <tr>
          <td class="form_list_1">排序</td>
