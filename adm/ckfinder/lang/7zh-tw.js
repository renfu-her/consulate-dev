...
CKFinder.lang['zh-tw'] =
{
	...
	common :
	{
		...
		unavailable		: '%1<span class="cke_accessibility">, 不可用</span>', // MISSING
		confirmCancel	: '有些選項被改變。你確定你要關閉對話窗口嗎？', // MISSING
		ok				: '確定', // MISSING
		cancel			: '取消', // MISSING
		...
		redo			: '重做', // MISSING
		skip			: '跳過', // MISSING
		skipAll			: '全部跳過', // MISSING
		makeDecision	: '應採取何樣措施?', // MISSING
	...
	FilesLoading	: '載入中...',
	FilesEmpty		: '空的目錄.', // MISSING
	FilesMoved		: '檔案 %1 傳動到 %2:%3.', // MISSING
	FilesCopied		: '檔案 %1 複製到 %2:%3.', // MISSING

	// Basket
	BasketFolder		: '暫存目錄', // MISSING
	BasketClear			: '清空暫存目錄', // MISSING
	...
	CopyDragDrop	: '把檔案複製到此', // MISSING
	MoveDragDrop	: '把檔案移動到此', // MISSING
	...
	UploadSend			: '上傳檔案',
	UploadAddFiles		: '加入檔案', // MISSING
	UploadClearFiles	: '清除檔案', // MISSING
	UploadCancel		: '取消上傳', // MISSING
	UploadRemove		: '刪除', // MISSING
	UploadRemoveTip		: '已刪除 !f', // MISSING
	UploadUploaded		: '已上傳 !n%', // MISSING
	UploadProcessing	: '上傳中...', // MISSING
