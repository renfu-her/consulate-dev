...
<body>
<div id="title_menu"><a href="index.php"><?php echo $admin_lang['adminnews'];?></a> &gt;  新增<?php echo $admin_lang['adminnews'];?></div>
<div id="menu_bar">
  <label>
   ...
   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return Validator.Validate(this,2)">
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         ...
         <td class="form_list_2"><input name="now_time" type="text" id="now_time" size="20" value="<?=date("Y-m-d")?>"/>
         (日期格式2012-01-01)          </td>
         <td class="form_list_3">&nbsp;</td>
       </tr>
       <tr>
         <td width="8%" class="form_list_1">*標題</td>
         <td width="68%" class="form_list_2"><input name="subject" type="text" id="subject" size="50" dataType="Require" msg="標題未輸入"/></td>
         <td width="24%" class="form_list_3">&nbsp;</td>
       </tr>
       <tr>
         <td class="form_list_1">圖片</td>
         <td class="form_list_2"><input type="file" name="file[]" size="10" />
         (圖片建議尺寸為：850x399pix)</td>
         <td class="form_list_3">&nbsp;</td>
       </tr>
       <tr>
          <td class="form_list_1">上架</td>
          <td class="form_list_2"><input type="radio" name="list" value="Y" checked="checked"/>上架 <input type="radio" name="list" value="N"/>下架 </td>
          <td class="form_list_3">&nbsp;</td>
       </tr>
       <tr>
